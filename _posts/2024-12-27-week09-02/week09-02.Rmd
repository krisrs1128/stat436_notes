...
_[Reading](https://rafalab.github.io/dsbook/clustering.html), [Recording](https://mediaspace.wisc.edu/media/Week%209%20%5B2%5D%20Hierarchical%20Clustering/1_8f9hgzpc), [Rmarkdown](https://github.com/krisrs1128/stat436_notes/blob/main/notes/2024-12-27-week09-02.Rmd)_
...
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_cutting.png")
```
...
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_algo.png")
```
...
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_merge1.png")
```
...
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_merge2.png")
```

```{r, fig.cap = "We can continue this process...", echo = FALSE, out.width = 600}
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_merge3.png")
```

```{r, fig.cap = "... and eventually we will construct the entire tree.", echo= FALSE, out.width = 600}
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_merge_pre_final.png")
```

```{r, echo = FALSE, out.width = 600}
include_graphics("https://krisrs1128.github.io/stat436_s25/posts/2024-12-27-week09-02/figure/hclust_merge_final.png")
```
