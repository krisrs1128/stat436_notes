...
[Reading](https://idyll.pub/post/visxai-dimensionality-reduction-1dbad0a67a092b007c526a45/), [Recording](https://mediaspace.wisc.edu/media/Week%2010%20%5B1%5D%20Introduction%20to%20Dimensionality%20Reduction/1_z4difn4d), [Rmarkdown](https://github.com/krisrs1128/stat436_notes/blob/main/notes/2024-12-27-week10-1.Rmd)_
...
include_graphics("https://github.com/krisrs1128/stat436_notes/blob/main/exercises/figure/brightness.png?raw=true")
```
...
include_graphics("https://github.com/krisrs1128/stat436_notes/blob/main/exercises/figure/dimred-animation.gif?raw=true")
```
