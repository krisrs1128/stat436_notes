...
```{r}
#| fig.cap: "A visualization of the internet
#| from the [Opte Project](https://opte.org)."
#| echo: FALSE
include_graphics("https://uwmadison.box.com/shared/static/cjk3i7mephlyguka9y5h1d40uy9rhdk2.png")
```
	
```{r}
#| fig.cap: "An evolutionary tree
#| from the [Interactive Tree of Life](https://itol.embl.de/)."
#| echo: FALSE
include_graphics("https://itol.embl.de/img/home/box2.png")
```
	
```{r}
#| fig.cap: "A COVID-19 transmission network
...
```{r}
#| fig.cap: "Directories in a file system can be organized into a tree
...
```{r}
#| fig.cap: "The same network as above
#| but with edge size encoding the weight attribute."
ggraph(G, layout = "kk") +
...
```{r}
#| fig.cap: "A representation of 1200 blogs before the 2004 election
#| from *The political blogosphere and the 2004 US election: divided they blog*."
#| echo: FALSE
...
```{r}
#| fig.cap: "A recommendation network
#| linking individuals and the movies that they viewed."
#| echo: FALSE
...
```{r}
#| fig.cap: "The scientific journal
#| Social Networks
#| links several publication communities
#| as found by *Betweenness Centrality as an Indicator of the  Interdisciplinarity of Scientific Journals*."
#| echo: FALSE
