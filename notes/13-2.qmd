...
```{r}
#| fig.cap: "A sample of 20 random images from the dog vs. cat training dataset."
...
```{r}
#| fig.cap: "An image and its activations for the first neuron in layer 1."
...
```{r}
#| preview: TRUE
#| fig.cap: "Activations for a collection of neurons at layer 2
#| for the same image as given above."
...
```{r}
#| fig.cap: "Activations for a collection of neurons at layer 6."
par(mfrow = c(6, 7), mai = rep(0.00, 4))
