...
```{r}
#| fig.cap: "An overview of the topic modeling process. Topics are distributions over words
#| and the word counts of new documents are determined by their degree of membership over a set of underlying topics. In an ordinary clustering model
#| the bars for the memberships would have to be either pure purple or orange. Here
...
```{r}
#| fig.cap: "A geometric interpretation of LDA
#| from the original paper by Blei
#| Ng
#| and Jordan."
#| echo: FALSE
#| out.width: 400
