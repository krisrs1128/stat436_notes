...
```{r}
#| fig.cap: "The silhouette statistics on the Palmers Penguins dataset
...
#| fig-height: 3
#| fig-width: 8
#| fig.cap: "The per-cluster histograms of silhouette statistics summarize how well-defined each cluster is."
ggplot(penguins3) +
...
```{r}
#| fig.cap: "We can repeat the same exercise
#| but with $K: 4$ clusters instead."
