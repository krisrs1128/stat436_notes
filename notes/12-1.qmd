...
```{r}
#| fig-cap: "Illustration of the $\\mathbf{x^{j \\vert = z}$ operation. The $j^{th}$ coordinate (1 in this case) for a selected observation is set equal to $z$."
#| echo: false
#| out-width: "700"
...
```{r}
#| fig.cap: "An example of why it is difficult to summarize the relationship between an input variable and a fitted surface for nonlinear models."
#| echo: FALSE
#| out.width: 500
...
```{r}
#| fig-cap: "Visual intuition behind the CP profile. Varying the $j^{th$ coordinate for an observation traces out a curve in the prediction surface."
#| preview: true
#| echo: false
#| out-width: "700"
...
```{r}
#| fig-cap: "CP and PDP profiles for age for a GBM fitted to the Titanic dataset."
