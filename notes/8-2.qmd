...
```{r}
#| fig-cap: "The same node-link diagram with either height or radius encoding depth in the tree."
#| column: page
#| fig-height: 8
#| fig-width: 18
...
```{r}
#| echo: false
#| fig-cap: "In edge bundling similar paths are placed close to one another."
