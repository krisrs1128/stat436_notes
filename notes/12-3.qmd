...
```{r}
#| fig.cap: "The relationship between satellite and ground station estimates of PM2.5."
...
```{r}
#| fig.cap: "The relationship between these variables is not the same across regions."
ggplot(GM@data, aes(log_sat, log_pm25)) +
...
```{r}
#| fig.cap: "We can define clusters of regions on our own
