...
```{r}
#| fig-width: 12
#| fig.cap: "A tree and the equivalent representation using containment. The outer circle corresponds to the root node in the tree
#| and paths down the tree are associated with sequences of nested circles."
...
```{r}
#| fig.cap: "A treemap representation associated with the tree from above."
