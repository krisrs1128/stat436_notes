...
```{r}
#| echo: FALSE
#| fig.cap: "We can recover clusters at different levels of granularity
#| by cutting a hierarchical clustering tree."
#| out.width: 600
...
```{r}
#| fig.cap: "At initialization
#| the hierarchical clustering routine has a cluster for each observation."
#| echo: FALSE
#| out.width: 600
...
```{r}
#| fig.cap: "Next
#| the two closest observations are merged into one cluster. This is the first merge point on the tree."
#| echo: FALSE
#| out.width: 600
...
```{r}
#| fig.cap: "We continue this at the next iteration
#| though this time we have compute the pairwise distance between all clusters
#| not observations (technically
#| all the observations were their own cluster at the first step
#| and in both cases
#| we compare the pairwise distances between clusters)."
#| echo: FALSE
#| out.width: 600
...
```{r}
#| fig.cap: "We can continue this process..."
#| echo: FALSE
#| out.width: 600
...
```{r}
#| fig.cap: "... and eventually we will construct the entire tree."
#| echo: FALSE
#| out.width: 600
